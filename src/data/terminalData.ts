...
export const PROJECTS: Record<PortfolioType, Line[]> = {
  frontend: [
    ...
    { type: 'item', text: '  · 티켓팅 사이트                   (진행중)' },
    { type: 'item', text: '  · Poke-Archive                 (완료)' },
...
export const SPECS: Line[] = [{ type: 'output', text: ' M5 Macbook Pro 14 24GB RAM 1TB SSD ' }];
